...
### Topic Health Checks
For checking topic health the [rosbag_recording_services](https://github.com/DavidBerschauer/rosbag_recording_services#topic-health-checks) is required. Please follow the installation instructions over there.
